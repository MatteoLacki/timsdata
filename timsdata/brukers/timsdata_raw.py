...
class TimsData:
    ...
    def __readScansHelper(self, frame_id, scan_begin, scan_end, read_func):
        ...
        while True:
            ...
            required_len = read_func(self.handle, frame_id, scan_begin, scan_end,
    ...
    def readScans(self, frame_id, scan_begin, scan_end):
        return self.__readScansHelper(frame_id, scan_begin, scan_end, self.dll.tims_read_scans_v2)

    def readScansRaw(self, frame_id, scan_begin, scan_end):
        return self.__readScansHelper(frame_id, scan_begin, scan_end, self.dll.tims_read_scans_internal)
